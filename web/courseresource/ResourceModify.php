...
<html lang="en"><!--<![endif]--> 
	...
	<body>
						...
						<legend>
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control popover-dismiss" id="resFile" name="resFile" value="" data-container="body" data-toggle="popover" data-placement="right" data-content="请选择文件">
                                    </div><!--End of controls-->
                                </div><!--End of form-group-->
        ...
        <script type="text/javascript" src="./ResourceModify.js"></script>
