					...
					<fieldset>
						<legend>
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <div class="btn-group pull-right"><button type="button" class="btn btn-primary" id="new" >新建题目</button></div>
                            </ul>
                              <div class="btn-group" >
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu" id="changeDifficult">
                                <div><li><a>简单</a></li></div>
                                <div><li><a>中等</a></li></div>
                                <div><li><a>困难</a></li></div>
                                <div><li class="divider"></li></div>
                                <div><li><a>所有</a></li></div>
                            </ul>
                        </div>
